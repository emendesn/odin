	...
	If SystemConcurso() == pTIME_MANIA
		...
		If ( nPointer := AScan( pSTRU_SYSTEM, { |xJog| xJog[ pSTRU_JOGO ] == pTIME_MANIA } ) ) > 0
			...
			begin sequence
				...
				CONCURSO->( dbSetOrder(2), dbSeek( pTIME_MANIA ) )
...
*	TIMIncluir()
*
*	Realiza a inclusao dos dados para o concurso da TIME MANIA.
*
		...
		If ( nPointer := AScan( pSTRU_SYSTEM, { |xJog| xJog[ pSTRU_JOGO ] == pTIME_MANIA } ) ) > 0
			...
			If Len( aClubes := LoadClubes() ) > 0
				...
				begin sequence
					...
					// Inicializa as Variaveis de no vetor aTimeMania
					xStoreTimeMania
					...
					while lContinua
						...
						@ oWindow:nTop+ 1, oWindow:nLeft+14 GET     pTIM_CONCURSO                                  ;
															PICT    '@K 99999'                                     ;
															SEND    VarPut(StrZero(Val(ATail(GetList):VarGet()),5));
															CAPTION 'Concurso'                                     ;
															COLOR   SysFieldGet()

						@ oWindow:nTop+ 1, oWindow:nLeft+30 GET     pTIM_SORTEIO                                   ;
															PICT    '@KD 99/99/99'                                 ;
															CAPTION 'Sorteio'                                      ;
															COLOR   SysFieldGet()
						...
						@ oWindow:nTop+ 3, oWindow:nLeft+ 9 GET   pTIM_DEZENA_01                                   ;
															PICT  '@K 99'                                          ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+13 GET   pTIM_DEZENA_02                                   ;
															PICT  '@K 99'                                          ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+17 GET   pTIM_DEZENA_03                                   ;
															PICT  '@K 99'                                          ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+21 GET   pTIM_DEZENA_04                                   ;
															PICT  '@K 99'                                          ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+25 GET   pTIM_DEZENA_05                                   ;
															PICT  '@K 99'                                          ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+29 GET   pTIM_DEZENA_06                                   ;
															PICT  '@K 99'                                          ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+33 GET   pTIM_DEZENA_07                                   ;
															PICT  '@K 99'                                          ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															COLOR SysFieldGet()
						...
						hb_DispOutAt( oWindow:nTop+ 4, oWindow:nLeft+ 2, ' Time do Coracao ', SystemLabelColor() )

						@ oWindow:nTop+ 5, oWindow:nLeft+ 5,                                                       ;
							oWindow:nTop+ 5, oWindow:nRight- 5 	GET      pTIM_CORACAO                              ;
																LISTBOX  aClubes                                   ;
																DROPDOWN                                           ;
						...
						// Coluna de Acertos			
						@ oWindow:nTop+ 8, oWindow:nLeft+10 GET     pTIM_ACERTO_07                                 ;
															PICT    '@EN 9,999,999,999'                            ;
															CAPTION '7 Acer.'                                      ;
															COLOR   SysFieldGet()                                  ;
															WHEN    AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '07', pTIM_SORTEIO )

						@ oWindow:nTop+ 9, oWindow:nLeft+10 GET     pTIM_ACERTO_06                                 ;
															PICT    '@EN 9,999,999,999'                            ;
															CAPTION '6 Acer.'                                      ;
															COLOR   SysFieldGet()                                  ;
															WHEN    AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '06', pTIM_SORTEIO )

						@ oWindow:nTop+10, oWindow:nLeft+10 GET     pTIM_ACERTO_05                                 ;
															PICT    '@EN 9,999,999,999'                            ;
															CAPTION '5 Acer.'                                      ;
															COLOR   SysFieldGet()                                  ;
															WHEN    AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '05', pTIM_SORTEIO )

						@ oWindow:nTop+11, oWindow:nLeft+10 GET     pTIM_ACERTO_04                                 ;
															PICT    '@EN 9,999,999,999'                            ;
															CAPTION '4 Acer.'                                      ;
															COLOR   SysFieldGet()                                  ;
															WHEN    AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '04', pTIM_SORTEIO )

						@ oWindow:nTop+12, oWindow:nLeft+10 GET     pTIM_ACERTO_03                                 ;
															PICT    '@EN 9,999,999,999'                            ;
															CAPTION '3 Acer.'                                      ;
															COLOR   SysFieldGet()                                  ;
															WHEN    AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '03', pTIM_SORTEIO )

						@ oWindow:nTop+13, oWindow:nLeft+10 GET     pTIM_ACERTO_CORACAO                            ;
															PICT    '@EN 9,999,999,999'                            ;
															CAPTION 'Tim Cor.'                                     ;
															COLOR   SysFieldGet()
						...
						// Coluna de Premios			
						@ oWindow:nTop+ 8, oWindow:nLeft+24 GET   pTIM_PREMIO_07                                   ;
															PICT  '@EN 99,999,999,999.99'                          ;
															COLOR SysFieldGet()                                    ;
															WHEN  AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '07', pTIM_SORTEIO )

						@ oWindow:nTop+ 9, oWindow:nLeft+24 GET   pTIM_PREMIO_06                                   ;
															PICT  '@EN 99,999,999,999.99'                          ;
															COLOR SysFieldGet()                                    ;
															WHEN  AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '06', pTIM_SORTEIO )

						@ oWindow:nTop+10, oWindow:nLeft+24 GET   pTIM_PREMIO_05                                   ;
															PICT  '@EN 99,999,999,999.99'                          ;
															COLOR SysFieldGet()                                    ;
															WHEN  AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '05', pTIM_SORTEIO )

						@ oWindow:nTop+11, oWindow:nLeft+24 GET   pTIM_PREMIO_04                                   ;
															PICT  '@EN 99,999,999,999.99'                          ;
															COLOR SysFieldGet()                                    ;
															WHEN  AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '04', pTIM_SORTEIO )

						@ oWindow:nTop+12, oWindow:nLeft+24 GET   pTIM_PREMIO_03                                   ;
															PICT  '@EN 99,999,999,999.99'                          ;
															COLOR SysFieldGet()                                    ;
															WHEN  AvalCondRateio( pSTRU_SYSTEM[ nPointer ][ pSTRU_REGRA_PREMIACAO ], '03', pTIM_SORTEIO )

						@ oWindow:nTop+13, oWindow:nLeft+24 GET   pTIM_PREMIO_CORACAO                              ;
															PICT  '@EN 99,999,999,999.99'                          ;
															COLOR SysFieldGet()
						...
						@ oWindow:nBottom- 1, oWindow:nRight-22 GET     lPushButton PUSHBUTTON                     ;
																...
																COLOR   SysPushButton()                            ;
																STYLE   ''                                         ;
																WHEN    Val( pTIM_CONCURSO ) > 0 .and.             ;
																		.not. Empty( pTIM_SORTEIO ) .and.          ;
																		.not. Empty( pTIM_CORACAO ) .and.          ;
																		.not. Empty( pTIM_DEZENA_01 ) .and.        ;
																		.not. Empty( pTIM_DEZENA_02 ) .and.        ;
																		.not. Empty( pTIM_DEZENA_03 ) .and.        ;
																		.not. Empty( pTIM_DEZENA_04 ) .and.        ;
																		.not. Empty( pTIM_DEZENA_05 ) .and.        ;
																		.not. Empty( pTIM_DEZENA_06 ) .and.        ;
																		.not. Empty( pTIM_DEZENA_07 )              ;
						...
						If lContinua .and. LastKey() != K_ESC
							...
							pTIM_CONCURSO := StrZero( Val( pTIM_CONCURSO ), 5 )

							//************************************************************************
							//*Verifica se concurso ja existe                                        *
							//************************************************************************
							If .not. CONCURSO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO ) )

								//************************************************************************
								//*Verifica a duplicidade de dezenas no concurso                         *
								//************************************************************************
								If xDuplicSequencia( aTimeMania[ pTIM_POS_DADOS ][ pTIM_POS_DEZENAS ] )

									//************************************************************************
									//*Verifica cada item da primeira sequencia para identificar se o valor  *
									//*digitado esta dentro da faixa especifica do concurso                  *
									//************************************************************************
									If xVerificaSequencia( 	aTimeMania[ pTIM_POS_DADOS ][ pTIM_POS_DEZENAS ], ;
				...
				always
					...
					oIniFile:WriteString( 'TIMEMANIA', 'AUTO_SEQUENCE', cAutoSequence )
...
*	TIMModificar()
*
*	Realiza a manutencao dos dados para o concurso da TIME MANIA.
*
...
memvar xCount, xTemp
	...
	//************************************************************************
	// A rotina so deve ser executada a partir de concurso time mania
	//************************************************************************
	If CONCURSO->CON_JOGO == pTIME_MANIA
		...
		If ( nPointer := AScan( pSTRU_SYSTEM, { |xJog| xJog[ pSTRU_JOGO ] == pTIME_MANIA } ) ) > 0
			...
			If Len( aClubes := LoadClubes() ) > 0		
				...
				begin sequence
					...
					//
					pTIM_CONCURSO := CONCURSO->CON_CONCUR
					pTIM_SORTEIO  := CONCURSO->CON_SORTEI
					...
					If JOGOS->( dbSetOrder(1), dbSeek( CONCURSO->CON_JOGO + CONCURSO->CON_CONCUR ) )
						while nPos++ <= Len( AllTrim( JOGOS->JOG_DEZENA ) )
							If IsDigit( SubStr( AllTrim( JOGOS->JOG_DEZENA ), nPos, 1 ) )
								aTimeMania[ pTIM_POS_DADOS ][ pTIM_POS_DEZENAS ][ nCount++ ] := SubStr( AllTrim( JOGOS->JOG_DEZENA ), nPos++, 2 )
							EndIf
						enddo

						pTIM_CORACAO := JOGOS->JOG_TIM_CO
						...
						while RATEIO->RAT_JOGO == CONCURSO->CON_JOGO .and.  ;
							...
							do case
								case RATEIO->RAT_FAIXA == '03'
									pTIM_ACERTO_03 := RATEIO->RAT_ACERTA
									pTIM_PREMIO_03 := RATEIO->RAT_RATEIO
								case RATEIO->RAT_FAIXA == '04'
									pTIM_ACERTO_04 := RATEIO->RAT_ACERTA
									pTIM_PREMIO_04 := RATEIO->RAT_RATEIO
								case RATEIO->RAT_FAIXA == '05'
									pTIM_ACERTO_05 := RATEIO->RAT_ACERTA
									pTIM_PREMIO_05 := RATEIO->RAT_RATEIO
								case RATEIO->RAT_FAIXA == '06'
									pTIM_ACERTO_06 := RATEIO->RAT_ACERTA
									pTIM_PREMIO_06 := RATEIO->RAT_RATEIO
								case RATEIO->RAT_FAIXA == '07'
									pTIM_ACERTO_07 := RATEIO->RAT_ACERTA
									pTIM_PREMIO_07 := RATEIO->RAT_RATEIO
								case RATEIO->RAT_FAIXA == 'TI'
									pTIM_ACERTO_CORACAO := RATEIO->RAT_ACERTA
									pTIM_PREMIO_CORACAO := RATEIO->RAT_RATEIO
							endcase
							RATEIO->( dbSkip() )
						enddo
					EndIf
					...
					while lContinua
						...
						@ oWindow:nTop+ 3, oWindow:nLeft+ 9 GET   pTIM_DEZENA_01                                   ;
															VALID .not. Empty( pTIM_DEZENA_01 )                    ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															PICT  '@K 99'                                          ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+13 GET   pTIM_DEZENA_02                                   ;
															VALID .not. Empty( pTIM_DEZENA_02 )                    ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															PICT  '@K 99'                                          ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+17 GET   pTIM_DEZENA_03                                   ;
															VALID .not. Empty( pTIM_DEZENA_03 )                    ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															PICT  '@K 99'                                          ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+21 GET   pTIM_DEZENA_04                                   ;
															VALID .not. Empty( pTIM_DEZENA_04 )                    ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															PICT  '@K 99'                                          ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+25 GET   pTIM_DEZENA_05                                   ;
															VALID .not. Empty( pTIM_DEZENA_05 )                    ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															PICT  '@K 99'                                          ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+29 GET   pTIM_DEZENA_06                                   ;
															VALID .not. Empty( pTIM_DEZENA_06 )                    ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															PICT  '@K 99'                                          ;
															COLOR SysFieldGet()

						@ oWindow:nTop+ 3, oWindow:nLeft+33 GET   pTIM_DEZENA_07                                   ;
															VALID .not. Empty( pTIM_DEZENA_07 )                    ;
															SEND  VarPut(StrZero(Val(ATail(GetList):VarGet()),2))  ;
															PICT  '@K 99'                                          ;
															COLOR SysFieldGet()
...
*	TIMExcluir()
*
*	Realiza a exclusao do concurso da TIME MANIA.
*
*   TIMMntBrowse -> TIMExcluir
*
*/
STATIC PROCEDURE TIMExcluir
...
*	TIMGravaDados()
*
*	Realiza a gravacao dos dados da TIME MANIA.
*
*/
STATIC FUNCTION TIMGravaDados
...
local lRetValue := pFALSE
	...
	begin sequence
		...
		while .not. lRetValue			
			...
			If iif( CONCURSO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO ) ), CONCURSO->( NetRLock() ), CONCURSO->( NetAppend() ) )
				CONCURSO->CON_JOGO   := pTIME_MANIA
				CONCURSO->CON_CONCUR := pTIM_CONCURSO
				CONCURSO->CON_SORTEI := pTIM_SORTEIO
				CONCURSO->( dbUnlock() )
			EndIf

			If iif( JOGOS->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO ) ), JOGOS->( NetRLock() ), JOGOS->( NetAppend() ) )
				JOGOS->JOG_JOGO   := pTIME_MANIA
				JOGOS->JOG_CONCUR := pTIM_CONCURSO
				JOGOS->JOG_TIM_CO := pTIM_CORACAO
				JOGOS->JOG_DEZENA := ParseString( aTimeMania[ pTIM_POS_DADOS ][ pTIM_POS_DEZENAS ] )
				JOGOS->( dbUnlock() )
			EndIf

			If iif( RATEIO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO + '03' ) ), RATEIO->( NetRLock() ), RATEIO->( NetAppend() ) )
				RATEIO->RAT_JOGO   := pTIME_MANIA
				RATEIO->RAT_CONCUR := pTIM_CONCURSO
				RATEIO->RAT_FAIXA  := '03'
				RATEIO->RAT_ACERTA := pTIM_ACERTO_03
				RATEIO->RAT_RATEIO := pTIM_PREMIO_03
				RATEIO->( dbUnlock() )
			EndIf

			If iif( RATEIO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO + '04' ) ), RATEIO->( NetRLock() ), RATEIO->( NetAppend() ) )
				RATEIO->RAT_JOGO   := pTIME_MANIA
				RATEIO->RAT_CONCUR := pTIM_CONCURSO
				RATEIO->RAT_FAIXA  := '04'
				RATEIO->RAT_ACERTA := pTIM_ACERTO_04
				RATEIO->RAT_RATEIO := pTIM_PREMIO_04
				RATEIO->( dbUnlock() )
			EndIf

			If iif( RATEIO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO + '05' ) ), RATEIO->( NetRLock() ), RATEIO->( NetAppend() ) )
				RATEIO->RAT_JOGO   := pTIME_MANIA
				RATEIO->RAT_CONCUR := pTIM_CONCURSO
				RATEIO->RAT_FAIXA  := '05'
				RATEIO->RAT_ACERTA := pTIM_ACERTO_05
				RATEIO->RAT_RATEIO := pTIM_PREMIO_05
				RATEIO->( dbUnlock() )
			EndIf

			If iif( RATEIO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO + '06' ) ), RATEIO->( NetRLock() ), RATEIO->( NetAppend() ) )
				RATEIO->RAT_JOGO   := pTIME_MANIA
				RATEIO->RAT_CONCUR := pTIM_CONCURSO
				RATEIO->RAT_FAIXA  := '06'
				RATEIO->RAT_ACERTA := pTIM_ACERTO_06
				RATEIO->RAT_RATEIO := pTIM_PREMIO_06
				RATEIO->( dbUnlock() )
			EndIf

			If iif( RATEIO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO + '07' ) ), RATEIO->( NetRLock() ), RATEIO->( NetAppend() ) )
				RATEIO->RAT_JOGO   := pTIME_MANIA
				RATEIO->RAT_CONCUR := pTIM_CONCURSO
				RATEIO->RAT_FAIXA  := '07'
				RATEIO->RAT_ACERTA := pTIM_ACERTO_07
				RATEIO->RAT_RATEIO := pTIM_PREMIO_07
				RATEIO->( dbUnlock() )
			EndIf

			If iif( RATEIO->( dbSetOrder(1), dbSeek( pTIME_MANIA + pTIM_CONCURSO + 'TI' ) ), RATEIO->( NetRLock() ), RATEIO->( NetAppend() ) )
				RATEIO->RAT_JOGO   := pTIME_MANIA
				RATEIO->RAT_CONCUR := pTIM_CONCURSO
				RATEIO->RAT_FAIXA  := 'TI'
				RATEIO->RAT_ACERTA := pTIM_ACERTO_CORACAO
				RATEIO->RAT_RATEIO := pTIM_PREMIO_CORACAO
				RATEIO->( dbUnlock() )
			EndIf
...
*
*   TIMMntBrowse -> TIMAcoes
*
*/
STATIC PROCEDURE TIMAcoes
...
*
*   TIMMntBrowse -> TIMAcoes -> TIMCombina
*
*/
STATIC PROCEDURE TIMCombina
...
local nOpcao      := 1
local nQuantJog   := 1
local nQuantDez   := pTIM_DEF_MIN_DEZENAS
local nQuantGrp   := 1
		...
		while lContinua
			...
			@ oWindow:nBottom- 1, oWindow:nRight-22 GET     lPushButton PUSHBUTTON                  ;
													...
													WHEN    nQuantJog >= 1 .and.                    ;
															nQuantJog <= pTIM_DEF_MAX_COMB .and.    ;
															nQuantDez >= pTIM_DEF_MIN_DEZENAS .and. ;
															nQuantDez <= pTIM_DEF_MAX_DEZENAS .and. ;
															nQuantGrp >= 1                          ;
													STATE   { || lContinua := pTRUE, GetActive():ExitState := GE_WRITE }
			...
			If lContinua .and. LastKey() != K_ESC
				...
				do case
					case nOpcao == 1
						TIMAnaliAleatoria( nQuantJog, nQuantDez )
					...
					case nOpcao == 4
						TIMGeraGrupos( nQuantJog, nQuantDez, nQuantGrp )
...
*	TIMAnaliAleatoria()
*
*	Realiza a geracao das dezenas para a TIME MANIA aleatoriamente.
*
*   TIMMntBrowse -> TIMAcoes -> TIMCombina -> TIMAnaliAleatoria
*
*   nQuantJogos : Informa a quantidade de jogos a ser geradas
* nQuantDezenas : Informa o numero de dezenas a ser geradas por jogos
*
*/
STATIC PROCEDURE TIMAnaliAleatoria( nQuantJogos, nQuantDezenas )
...
local aSequencia
	...
	DEFAULT nQuantJogos   TO 1, ;
			nQuantDezenas TO pTIM_DEF_MIN_DEZENAS
...
*	Realiza a geracao das dezenas para a TIME MANIA aleatoriamente.
*
*   TIMMntBrowse -> TIMAcoes -> TIMCombina -> TIMGeraGrupos
*
*   nQuantJogos : Informa a quantidade de jogos a ser geradas
* nQuantDezenas : Informa o numero de dezenas a ser geradas por jogos
...
*
*/
STATIC PROCEDURE TIMGeraGrupos( nQuantJogos, nQuantDezenas, nQuantGrupos )
...
*
*   TIMMntBrowse -> TIMAcoes -> TIMCombina -> TIMAnaliAleatoria -> TIMShowAposta
*
*/
STATIC PROCEDURE TIMShowAposta
...
*	TIMRelResult()
*
*	Realiza a impressao dos resultados da TIME MANIA.
*
*   TIMMntBrowse -> TIMAcoes -> TIMCombina -> TIMRelResult
*
*/
STATIC PROCEDURE TIMRelResult
				...
				If lContinua .and. LastKey() != K_ESC
					...
					If CONCURSO->( dbSetOrder(1), dbSeek( pTIME_MANIA + cInicio ) ) .and. ;
						...
						begin sequence
							...
							oPDFReport:SetInfo( 'EDILSON MENDES', 'ODIN', 'RESULTADOS TIME MANIA', oPDFReport:cFileName )

							nLinha := oPDFReport:MaxCol()

							//Posiciona o Registro
							If CONCURSO->( dbSetOrder(1), dbSeek( pTIME_MANIA + cInicio ) )
								...
								while Eval( bFiltro )
									...
									If nLinha >= ( oPDFReport:MaxCol() - 35 )
										...
										oPDFReport:DrawText( 1, 26, PadC( 'RESULTADOS TIME MANIA', 70 ), , 10, 'Helvetica-Bold' )
										...
										oPDFReport:DrawText( 3, 3, 'CONCURSO                 DATA                           TIME DO CORACAO                          DEZENAS', , 10, 'Helvetica-Bold' )
